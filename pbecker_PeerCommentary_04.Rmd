...
#PMB: I like how you put in example datasets. It makes it easier to follow/ understand.
...
<!-- PMB: This code looks super good. I think it's a normal thing to see a negative z score. Just means it's below the mean I think. I think you did add p1, n1 to the fuction no? They are definitely in there. -->
...
<!-- PMB: These graphs look great. Well done. No notes! -->
...
<!-- PMB: These all look right to me. (Aka I got the same things) -->
...
<!-- PMB: You could embed this source to a word if you want like: word[url] -->
...
<!-- PMB: These are again, incredibly well done. I also struggled with the lengths differing. I still couldn't figure out how to do the log one so I am very impressed. It was super smart of you to use v = seq(). I should do that too to take care of the issue. -->
...
<!-- PMB: I pretty much came to these same conclusions. I felt the CIs were too far apart to be reliable and that the log version was slightly better. -->

<!-- Final thoughts: To be honest, I think this looks amazing. The areas where I really struggled (creating the graphs with the prediction lines), you made look easy! I think using base R code was the way to go for that. I tried using ggplot, but I think got in over my head. Seriously, I think you have a great understanding of this assignment and I am thoroughly impressed. The only really feedback I have is you could tidy up your commentary by embedding links in words, bolding or italizing things, and maybe choosing a fun theme with a table on contents. Seriously, well done Amanda!!!! -->
